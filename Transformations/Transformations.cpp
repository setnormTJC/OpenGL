...
#pragma endregion opens window, does glad stuff
    ...
    Shader ourShader("../myResources/shaders/shader.vs", "../myResources/shaders/shader.fs");
...
#pragma region the render loop 
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //drawing a SECOND box with different transformation (in different loc) 
        trans = glm::mat4(1.0f);  //reset to identity

        trans = glm::translate(trans, glm::vec3(0.5f, 0.0f, 0.0f));
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans)); //MUST get called again
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
